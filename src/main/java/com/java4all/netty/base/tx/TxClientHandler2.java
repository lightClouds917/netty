 ...
 * @author IT云清
 */
public class TxClientHandler2 extends ChannelInboundHandlerAdapter{

    private static final Logger LOGGER = LoggerFactory.getLogger(TxClientHandler2.class);

    public TxClientHandler2() {
        super();
    }
